...
export const getAdministrationUsersSessionsRoute = createRoute({
  method: 'get',
  path: '/',
  tags: ['Administration'],
  summary: 'Get administration users sessions module overview (dummy)',
  security: [{ AuthorizationBearer: [] }],
  responses: {
    200: {
      description:
        'Administration users sessions overview returned successfully',
      content: {
        'application/json': {
